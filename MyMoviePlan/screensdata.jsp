...
while(rs.next())
{
			System.out.println("select * from shows_tab where tid_ct='"+rs.getString(1)+"' and screen_ct='"+rs.getString(3)+"' ");

			rs2=st2.executeQuery("select * from shows_tab where tid_ct='"+rs.getString(1)+"' and screen_ct='"+rs.getString(3)+"' ");
			if(rs2.next()){
			System.out.println("-------------");
			}else{
							System.out.println("-------------");
